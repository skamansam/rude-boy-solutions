...
>
    ...
    <div class="flex flex-col w-full lg:w-[1150px] justify-center">
        <motion.div
            initial={{ opacity: 0 }}
        ...
        >
            <div class="block-subtitle text-center mb-6">Testimonials</div>
            <div
                class="block-big-title text-center mb-20 px-8 sm:px-24 md:px-48"
            >
                People like you love Tailcast
            </div>

            <div
                class="flex flex-col lg:flex-row gap-8 lg:gap-5 xl:gap-10 px-6 xl:px-0 items-center"
            >
                {#each testimonialsData as testimonial, index}
                    <div
                        class="w-11/12 sm:w-4/5 md:w-[560px] lg:w-1/3 main-border-gray-darker rounded-xl bg-bgDark3 flex flex-col px-6 py-4"
                    ...
                    >
                        ...
                        <div class="flex mt-4 mb-2 xl:mt-8 xl:mb-4">
                            <div>
                                <img
